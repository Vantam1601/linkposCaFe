...
import SliderShortTerm from 'src/screens/short.term/slider.short.term';
import CellBox from 'src/screens/need/component/CellBox';
import {checkUrlSvg, sortListItemByDate, TypeItem, } from "src/helpers/constants";

const widthS = Dimensions.get("window").width;
const WIDTH_ITEM = (widthS - 40) / 1.8;

const ABCNHI = memo((navigationRoute: any) => {
