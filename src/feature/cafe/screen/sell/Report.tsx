  ...
  return (
    <View style={{ flex: 1, backgroundColor: COLOR.bg }}>
      ...
      <ScrollView style={{ flex: 1 }}>
        <ItemMenu screen={"SellInvToday"} name={"Lịch sử đơn hàng"} />
        <ItemMenu screen={"FingerQrcode"} name={"Mã Chấm công"} />
        {/*<ItemMenu screen={"SellFingerHistory"} name={"Lịch sử chấm công"} />*/}
        <ItemMenu screen={"ComingSoon"} name={"Lịch sử chấm công"} />
        <ItemMenu screen={"SellConfig"} name={"Cài đặt"} />
      </ScrollView>
    </View>
  );
};
