...
const FingerQrcode = (props) => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: COLOR.bg }}>
      <HeaderBack title={`Mã chấm công`} />
      <View style={{ flex: 1,alignItems: 'center',justifyContent: 'center'}}>
          {token?
            <View style={{ alignItems: 'center',justifyContent: 'center'}}><View style={{marginBottom:16}}>
                <QRCode
              size={215}
              value={token}
            ...
            <Text>Nhân viên vui lòng quét mã QRCODE bên giới để chấm công. Chú ý: chỉ quét một lần là "Vô Ca" và "Tan ca"</Text>
          </View>:null}
      </View>
